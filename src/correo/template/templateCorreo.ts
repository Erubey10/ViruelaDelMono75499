...
export function generateIncidentEmailTemplate(genre: string, age:number, lat: string, lng: string, creationDate:NativeDate|null|undefined): string {
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <p><strong>Genero d:</strong> ${genre}</p>
                <p><strong>Edad del paciente:</strong> ${age}</p>
